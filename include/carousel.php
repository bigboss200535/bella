    ...
    <div class="carousel-item active">
        ...
        <div class="carousel-caption">
            <div class="p-3" style="max-width: 900px;">
                <h5 class="text-white text-uppercase fw-bold mb-1" style="letter-spacing: 3px;">Explore The World</h5>
                <h1 class="display-2 text-capitalize text-white mb-1">Experience luxury travel with Bellas Prestige</h1>
...
<button class="carousel-control-prev" type="button" data-bs-target="#carouselId" data-bs-slide="prev">
    <span class="carousel-control-prev-icon btn bg-gold" aria-hidden="false"></span>
    <span class="visually-hidden" style="background-color: #DAA520;">Previous</span>
</button>
<button class="carousel-control-next" type="button" data-bs-target="#carouselId" data-bs-slide="next">
    <span class="carousel-control-next-icon btn bg-gold" aria-hidden="false" style="background-color: #DAA520;"></span>
