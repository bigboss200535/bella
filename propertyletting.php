<?php include('include/head.php'); ?>
    <body>
        ...
        <!-- Header Start -->
         <div class="container-fluid propertyletting">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Property Letting</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="property.php">Properties</a></li>
                    <li class="breadcrumb-item active text-white">Property Letting</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid destination py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Our Properties to let</h5>
