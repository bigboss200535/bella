...
<html lang="en">
    ...
    <body>
        <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center" style="background-color:#DAA520">
        ...
        <!-- Spinner End -->
        <!-- Topbar Start -->
        <div class="container-fluid btn-gold px-5 d-none d-lg-block">
            <div class="row gx-0">
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        ...
                        <a href="#"><small class="me-3 text-primary"><i class="fa fa-sign-in-alt me-2"></i>Login</small></a>
                       <!--  <div class="dropdown">
            ...
            <div class="carousel-header">
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselId" data-bs-slide="prev">
                        ...
                        <span class="visually-hidden" style="background-color: #DAA520;">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselId" data-bs-slide="next">
                        <span class="carousel-control-next-icon btn bg-primary" aria-hidden="false" style="background-color: #DAA520;"></span>
