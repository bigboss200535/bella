<?php include('include/head.php'); ?>
    ...
    <div class="row g-5 align-items-center">
        ...
        <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8))">
            ...
            <p class="mb-4" align="justify">Bellas Prestige Limited is a premier company that specializes in providing exceptional experiences to our clients. We have established ourselves as a trusted and reliable source for all your travel, homecare, education and accomodational needs.</p>
